...
- [`src/main/webapp/ai_disclosure_examples.ai.html`](https://gxworks.github.io/ai_disclosure_examples.ai.html) — examples per language
- [`src/main/webapp/ai_disclosure_details.ai.html`](https://gxworks.github.io/ai_disclosure_details.ai.html) — rationale and conventions discussion
